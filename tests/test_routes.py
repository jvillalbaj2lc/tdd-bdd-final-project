...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        ...
        # Create 1 product and grab the first one
        test_product = self._create_products(1)[0]

        # Make a GET request for that product by ID
    ...
    def test_get_product_not_found(self):
        """It should return 404 when trying to get a Product that doesn't exist"""
        # Here '99999' or '0' is presumably not in the DB
    ...
    def test_update_product_not_found(self):
        """It should return 404 when trying to update a Product that doesn't exist"""
        ...
        response = self.client.put(f"{BASE_URL}/{fake_product_id}", json=updated_product)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        data = response.get_json()
        self.assertIn("was not found", data["message"])
